                                    ...
                                    <div class="col-xl-12 mx-auto">
                                        ...
                                        <div class="card">
                                            <div class="card-body p-4">
                                                ...
                                                <form class="row g-3" action="{{ route('room.store') }}" method="post"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        {{-- <input type="text" name="room_type" class="form-control"
                                                            id="input1" value="{{ $room->type->name }}"> --}}
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea name="short_desc" class="form-control" id="myeditorinstance"></textarea>
                                                    </div>
                                                    <div class="row mt-2">
