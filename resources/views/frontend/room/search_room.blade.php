            ...
            <div class="row pt-45">
                ...
                @foreach ($rooms as $item)
                    @php
                        ...
                        $av_room = @$item->count('id') - $total_book_room;

                    @endphp
                    @if ($av_room > 0 && old('person') <= $item->room_capacity)
                        <div class="col-lg-4 col-md-6">
                            <div class="room-card">
                                ...
                                <div class="content">
                                    <h6>
                                        <a
                                            href="{{ route('search_room_details', $item->id . '?check_in=' . old('check_in') . '&check_out=' . old('check_out') . '&person=' . old('person')) }}">{{ $item->room_type }}</a>
                                    </h6>
